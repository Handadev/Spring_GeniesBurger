...
<div class="container p-3 my-3 border" style="text-align: center;">
  ...
  <br>
  <p><a href="/member/modify?mno=${ses.mno }" style="color:red; font-size:30px; line-height:20px;">정보변경 ></a></p>
  <p><a href="/review/myReview?email=${ses.email }" style="color:red; font-size:30px; line-height:20px;">나의 리뷰 ></a></p>
  <br>
